...
declare global {
  ...
  const apiHealth: typeof import('../../src/api/health')['apiHealth']
  const apiLog: typeof import('../../src/api/log')['apiLog']
  const apiMerge: typeof import('../../src/api/merge')['apiMerge']
  const apiPendingResolution: typeof import('../../src/api/pendingResolution')['apiPendingResolution']
  ...
  const apiSeries: typeof import('../../src/api/series')['apiSeries']
  ...
  const needsBangumiRuleReview: typeof import('../../src/utils/review-status')['needsBangumiRuleReview']
  ...
  const useHealthStore: typeof import('../../src/store/health')['useHealthStore']
  const useI18n: typeof import('vue-i18n')['useI18n']
  const useLogStore: typeof import('../../src/store/log')['useLogStore']
  const useMergeHistoryStore: typeof import('../../src/store/mergeHistory')['useMergeHistoryStore']
  ...
  const useSeriesStore: typeof import('../../src/store/series')['useSeriesStore']
